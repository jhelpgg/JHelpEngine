...
public class Scene
{
    ...
    *           OpenGL utilities
    */
   void renderPickingUV(final Node node, final GL gl, final GLU glu)
   {
    ...
    *           Scene renderer
    */
   synchronized void renderTheScene(final GL gl, final GLU glu, final JHelpSceneRenderer sceneRenderer)
   {
      Node node;
      // Get the node's list
    ...
    *           Scene renderer
    */
   void renderTheScenePicking(final GL gl, final GLU glu, final JHelpSceneRenderer sceneRenderer)
   {
