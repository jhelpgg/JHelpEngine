...
public class TextIn3DUtil
{
    ...
    */
   public static Object2D creteTextObject2D(final int x, final int y, final String text, final Font font, final TextAlignment textAlignment,
    ...
    * @return Created object
    */
   public static Object2D creteTextObject2D(final int x, final int y, final String[] lines, final Font font, final TextAlignment textAlignment,
         final Color foreGround, final Color backGround)
   {
      Texture texture;
      Object2D object2D;
