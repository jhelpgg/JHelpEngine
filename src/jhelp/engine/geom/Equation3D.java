        ...
        extends Object3D
{
     ...
     *           Function Z : z = Z(t)
     */
    public Equation3D(final Path border, final int borderPrecision, final float tStart, final float tEnd,
                      final float tStep, final Function fonctionX,
                      ...
                      final Function fonctionY, final Function fonctionZ, final Equation3DListener equation3DListener)
    {
        ...
        ThreadManager.THREAD_MANAGER.doThread(
                new Creator(border, borderPrecision, tStart, tEnd, tStep, fonctionX.simplifyMaximum(),
                            fonctionY.simplifyMaximum(),
     ...
     */
    public Equation3D(final Path border, final int borderPrecision, final float tStart, final float tEnd,
                      final float tStep, final String fonctionX,
                      final String fonctionY, final String fonctionZ)
    {
        this(border, borderPrecision, tStart, tEnd, tStep, Function.parse(fonctionX), Function.parse(fonctionY),
             Function.parse(fonctionZ), null);
    }
    ...
    {
        this(border, borderPrecision, tStart, tEnd, tStep, Function.parse(fonctionX), Function.parse(fonctionY),
             Function.parse(fonctionZ), equation3DListener);
    }
            ...
            extends ThreadedVerySimpleTask
    {
         ...
         *           Function of Z : z = Z(t)
         */
        Creator(final Path border, final int borderPrecision, final float start, final float end, final float step,
                final Function fonctionX,
                final Function fonctionY, final Function fonctionZ)
        {
            this.border = border;
            this.borderPrecision = borderPrecision;
        ...
        protected void doVerySimpleAction()
        {
            ...
            final Function deriveX = this.fonctionX.derive(varT)
                                                   .simplifyMaximum();
            final Function deriveY = this.fonctionY.derive(varT)
                                                   .simplifyMaximum();
            final Function deriveZ = this.fonctionZ.derive(varT)
                                                   .simplifyMaximum();
            ...
            {
                dx = (float) deriveX.replace(varT, t)
                                    .simplifyMaximum()
                                    .obtainRealValueNumber();
                dy = (float) deriveY.replace(varT, t)
                                    .simplifyMaximum()
                                    .obtainRealValueNumber();
                dz = (float) deriveZ.replace(varT, t)
                                    .simplifyMaximum()
                                    .obtainRealValueNumber();
                ...
                x = (float) this.fonctionX.replace(varT, t)
                                          .simplifyMaximum()
                                          .obtainRealValueNumber();
                y = (float) this.fonctionY.replace(varT, t)
                                          .simplifyMaximum()
                                          .obtainRealValueNumber();
                z = (float) this.fonctionZ.replace(varT, t)
                                          .simplifyMaximum()
                                          .obtainRealValueNumber();

                //

                dx2 = (float) deriveX.replace(varT, t + this.tStep)
                                     .simplifyMaximum()
                                     .obtainRealValueNumber();
                dy2 = (float) deriveY.replace(varT, t + this.tStep)
                                     .simplifyMaximum()
                                     .obtainRealValueNumber();
                dz2 = (float) deriveZ.replace(varT, t + this.tStep)
                                     .simplifyMaximum()
                                     .obtainRealValueNumber();
                ...
                x2 = (float) this.fonctionX.replace(varT, t + this.tStep)
                                           .simplifyMaximum()
                                           .obtainRealValueNumber();
                y2 = (float) this.fonctionY.replace(varT, t + this.tStep)
                                           .simplifyMaximum()
                                           .obtainRealValueNumber();
                z2 = (float) this.fonctionZ.replace(varT, t + this.tStep)
                                           .simplifyMaximum()
                                           .obtainRealValueNumber();
