      ...
      extends NodeWithMaterial
{
    ...
    * @param glu
    *           Open GL utilities
    * @see jhelp.engine.Node#renderSpecific(GL, GLU)
    */
   @Override
    ...
    */
   @Override
   protected synchronized void renderSpecificPicking(final GL gl, final GLU glu)
   {
      if((this.reference == null) && (this.referenceName != null))
      {
         this.reference = (Object3D) this.getRoot().getFirstNode(this.referenceName);
    ...
    * @param glu
    *           Open GL utilities
    * @see jhelp.engine.Node#renderSpecificPickingUV(javax.media.opengl.GL, javax.media.opengl.glu.GLU)
    */
   @Override
