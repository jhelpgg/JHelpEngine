...
public class CubeMap
{
   ...
   public static final int BACK   = GL.GL_TEXTURE_CUBE_MAP_NEGATIVE_Z;
   /** For place a texture in the "bottom" face of the cube */
   public static final int BOTTOM = GL.GL_TEXTURE_CUBE_MAP_NEGATIVE_Y;
   /** For place a texture in the "face" face of the cube */
   public static final int FACE   = GL.GL_TEXTURE_CUBE_MAP_POSITIVE_Z;
   /** For place a texture in the "left" face of the cube */
   public static final int LEFT   = GL.GL_TEXTURE_CUBE_MAP_NEGATIVE_X;
   /** For place a texture in the "right" face of the cube */
   public static final int RIGHT  = GL.GL_TEXTURE_CUBE_MAP_POSITIVE_X;
