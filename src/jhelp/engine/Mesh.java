...
public class Mesh
{
    ...
    *           Face normals
    */
   private void render(final GL gl, final ArrayInt facePoints, final ArrayInt faceUV, final ArrayInt faceNormals)
   {
    ...
    *           Normal
    */
   private void render(final GL gl, final Point3D point, final Point2D uv, final Point3D normal)
   {
    ...
    *           OpenGL context
    */
   synchronized void render(final GL gl)
   {
      this.makeMeshValid();
