      ...
      implements NodeListener
{
   ...
   public static void main(final String[] args)
   {
      ...
      final JHelpFrame3D frame3d = new JHelpFrame3D(true, "Sample : Mouse detection");
      ...
      try
      {
         Texture texture = new Texture("TextureDiffuse", Texture.REFERENCE_RESOURCES, MouseDetection.RESOURCES.obtainResourceStream("floor068.jpg"));
         material.setTextureDiffuse(texture);

         texture = new Texture("TextureSpherique", Texture.REFERENCE_RESOURCES, MouseDetection.RESOURCES.obtainResourceStream("emerald_bk.jpg"));
      ...
      final MouseDetection detection = new MouseDetection();
